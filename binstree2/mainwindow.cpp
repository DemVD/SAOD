...
//! [7]
void MainWindow::itemInserted(DiagramItem *item){ // item insertion
    pointerTypeGroup->button(int(DiagramScene::MoveItem))->setChecked(true);
    scene->setMode(DiagramScene::Mode(pointerTypeGroup->checkedId()));
    buttonGroup->button(int(item->diagramType()))->setChecked(false);
    //emit textInserted();
    _rootMain.insertNode(10);
}
//! [7]

//! [8]
void MainWindow::textInserted(QGraphicsTextItem *){ // text insertion
...
void MainWindow::createToolBox()
{
    ...
    layout->addWidget(createCellWidget(tr("Node"), DiagramItem::Conditional), 0, 0);
...
//! [21]
    ...
    backgroundLayout->addWidget(createBackgroundCellWidget(tr("White Grid"),
                                                           ":/images/images/background2.png"), 1, 0);
    backgroundLayout->addWidget(createBackgroundCellWidget(tr("Gray Grid"),
                                                           ":/images/images/background3.png"), 2, 0);
    backgroundLayout->addWidget(createBackgroundCellWidget(tr("No Grid"),
                                                           ":/images/images/background4.png"), 3, 0);

    backgroundLayout->setRowStretch(2, 2);
    backgroundLayout->setColumnStretch(2, 2);
...
//! [22]
    ...
    toolBox->addItem(itemWidget, tr("Nodes"));
